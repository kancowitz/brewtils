    ...
    def __init__(
        ...
        **kwargs
        ...
        if api_version == 1:
            ...
            self.system_url = base_url + "/systems/"
            self.instance_url = base_url + "/instances/"
            self.command_url = base_url + "/commands/"
            self.request_url = base_url + "/requests/"
            self.queue_url = base_url + "/queues/"
            self.logging_config_url = base_url + "/config/logging/"
            self.job_url = base_url + "/jobs/"
            self.token_url = base_url + "/tokens/"
            self.user_url = base_url + "/users/"
        elif api_version == 2:
            base_url += "api/v2/namespaces"

            self.system_url = base_url + "/%s/systems/"
        else:
...
class RestClientV2(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        api_version = api_version or self.LATEST_VERSION
        if api_version == 2:
            v2_url = base_url + "api/v2"

            self.system_url = v2_url + "/namespaces/%s/systems/"
            self.instance_url = v2_url + "/namespaces/%s/instances/"
            self.command_url = v2_url + "/namespaces/%s/commands/"
            self.request_url = v2_url + "/namespaces/%s/requests/"
            self.queue_url = v2_url + "/namespaces/%s/queues/"
            self.logging_config_url = v2_url + "/namespaces/%s/config/logging/"
            self.job_url = v2_url + "/namespaces/%s/jobs/"
            self.event_url = v2_url + "/namespaces/%s/events/"
            self.token_url = v2_url + "/tokens/"
            self.user_url = v2_url + "/users/"
        else:
            raise ValueError("Invalid beer-garden API version: %s" % api_version)
    ...
    @enable_auth
    def get_systems(self, namespace=None, **kwargs):
        """Perform a GET on the System collection URL
        ...
        return self.session.get(
            self.system_url % (namespace or self.namespace), params=kwargs
        )

    @enable_auth
    def get_system(self, system_id, namespace=None, **kwargs):
        """Performs a GET on the System URL
        ...
        """
        return self.session.get(
            self.system_url % (namespace or self.namespace) + system_id, params=kwargs
        )

    @enable_auth
    def post_systems(self, payload, namespace=None):
        """Performs a POST on the System URL
        ...
        """
        return self.session.post(
            self.system_url % (namespace or self.namespace),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def patch_system(self, system_id, payload, namespace=None):
        """Performs a PATCH on a System URL
        ...
        """
        return self.session.patch(
            self.system_url % (namespace or self.namespace) + str(system_id),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def delete_system(self, system_id, namespace=None):
        """Performs a DELETE on a System URL
        ...
        return self.session.delete(
            self.system_url % (namespace or self.namespace) + system_id
        )

    @enable_auth
    def get_instance(self, instance_id, namespace=None):
        """Performs a GET on the Instance URL
        ...
        """
        return self.session.get(
            self.instance_url % (namespace or self.namespace) + instance_id
        )

    @enable_auth
    def patch_instance(self, instance_id, payload, namespace=None):
        """Performs a PATCH on the instance URL
        ...
        """
        return self.session.patch(
            self.instance_url % (namespace or self.namespace) + str(instance_id),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def delete_instance(self, instance_id, namespace=None):
        """Performs a DELETE on an Instance URL
    ...
    def get_commands(self, namespace=None):
        """Performs a GET on the Commands URL"""
        return self.session.get(self.command_url % (namespace or self.namespace))

    @enable_auth
    def get_command(self, command_id, namespace=None):
        """Performs a GET on the Command URL
        ...
        """
        return self.session.get(
            self.command_url % (namespace or self.namespace) + command_id
        )

    @enable_auth
    def get_requests(self, namespace=None, **kwargs):
        """Performs a GET on the Requests URL
        ...
        """
        return self.session.get(
            self.request_url % (namespace or self.namespace), params=kwargs
        )

    @enable_auth
    def get_request(self, request_id, namespace=None):
        """Performs a GET on the Request URL
        ...
        """
        return self.session.get(
            self.request_url % (namespace or self.namespace) + request_id
        )

    @enable_auth
    def post_requests(self, payload, namespace=None, **kwargs):
        """Performs a POST on the Request URL
        ...
        """
        return self.session.post(
            self.request_url % (namespace or self.namespace),
            data=payload,
            headers=self.JSON_HEADERS,
            params=kwargs,
        )
    ...
    @enable_auth
    def patch_request(self, request_id, payload, namespace=None):
        """Performs a PATCH on the Request URL
        ...
        """
        return self.session.patch(
            self.request_url % (namespace or self.namespace) + str(request_id),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def post_event(self, payload, publishers=None, namespace=None):
        """Performs a POST on the event URL
        ...
        """
        return self.session.post(
            self.event_url % (namespace or self.namespace),
            data=payload,
            headers=self.JSON_HEADERS,
            params={"publisher": publishers} if publishers else None,
        )
    ...
    @enable_auth
    def get_queues(self, namespace=None):
        """Performs a GET on the Queues URL

        :return: Response to the request
        """
        return self.session.get(self.queue_url % (namespace or self.namespace))

    @enable_auth
    def delete_queues(self, namespace=None):
        """Performs a DELETE on the Queues URL

        :return: Response to the request
        """
        return self.session.delete(self.queue_url % (namespace or self.namespace))

    @enable_auth
    def delete_queue(self, queue_name, namespace=None):
        """Performs a DELETE on a specific Queue URL

        :return: Response to the request
        """
        return self.session.delete(
            self.queue_url % (namespace or self.namespace) + queue_name
        )

    @enable_auth
    def get_jobs(self, namespace=None, **kwargs):
        """Performs a GET on the Jobs URL.

        Returns: Response to the request
        """
        return self.session.get(
            self.job_url % (namespace or self.namespace), params=kwargs
        )

    @enable_auth
    def get_job(self, job_id, namespace=None):
        """Performs a GET on the Job URL

        :param job_id: ID of job
        :return: Response to the request
        """
        return self.session.get(self.job_url % (namespace or self.namespace) + job_id)

    @enable_auth
    def post_jobs(self, payload, namespace=None):
        """Performs a POST on the Job URL
        ...
        """
        return self.session.post(
            self.job_url % (namespace or self.namespace),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def patch_job(self, job_id, payload, namespace=None):
        """Performs a PATCH on the Job URL
        ...
        """
        return self.session.patch(
            self.job_url % (namespace or self.namespace) + str(job_id),
            data=payload,
            headers=self.JSON_HEADERS,
        )

    @enable_auth
    def delete_job(self, job_id, namespace=None):
        """Performs a DELETE on a Job URL
        ...
        """
        return self.session.delete(
            self.job_url % (namespace or self.namespace) + job_id
        )
